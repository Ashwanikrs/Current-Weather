...
function weatherDetails(info){
    if(info.cod == "404"){
        ...
        if(id == 800){
            wIcon.src = "figure/sun.svg";
        }else if(id >= 200 && id <= 232){
            wIcon.src = "figure/storm.svg";  
        }else if(id >= 600 && id <= 622){
            wIcon.src = "figure/snowfall.svg";
        }else if(id >= 701 && id <= 781){
            wIcon.src = "figure/foggy-weather.svg";
        }else if(id >= 801 && id <= 804){
            wIcon.src = "figure/cloudy-weather.svg";
        }else if((id >= 500 && id <= 531) || (id >= 300 && id <= 321)){
            wIcon.src = "figure/rainy-weather.svg";
        }
